...
export default function ContactPage() {
   ...
   const contactItems = [
    { icon: MapPin, title: "Address", text: "123 Medical Lane\nHealth City, Dhaka 12345" },
    { icon: Phone, title: "Phone", text: "+123 456 7890" },
    { icon: Mail, title: "Email", text: "contact@phdoc.com" },
    { icon: Globe, title: "Website", text: "www.phdoc.com" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {contactItems.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-[#fcfcfc] border-1 border-[#ececec] rounded-lg shadow-sm hover:shadow-lg transition-transform hover:-translate-y-1 p-6 text-center"
              >
      ...
      <section className="bg-[#0071DF] py-12">
        <div className="container mx-auto px-4 md:px-8 lg:px-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 text-white">
            <Link href="https://facebook.com" target="_blank" className=" flex items-center gap-2 justify-center">
              <Facebook size={20} /> Facebook
            </Link>
            <Link href="https://twitter.com" target="_blank" className=" flex items-center gap-2 justify-center">
              <Twitter size={20} /> Twitter
            </Link>
            <Link href="https://instagram.com" target="_blank" className="flex items-center gap-2 justify-center">
              <Instagram size={20} /> Instagram
            </Link>
            <Link href="https://linkedin.com" target="_blank" className="flex items-center gap-2 justify-center">
