...
export const metadata: Metadata = {
  title: "Medicine Store Online - PH Doc",
  description: "Medicine Store Online services is upcoming feature of PH Doc.",
};
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-12">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Order your prescribed medicines online and get them delivered to
            your home. Safe, convenient, and affordable.
          </p>
        </div>
          ...
          <Card className="inline-block">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                We are working hard to bring you the best online medicine
                ordering experience. Stay tuned!
              </p>
              <Link href="/">
